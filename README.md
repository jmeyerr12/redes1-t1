...
## To-do
- Consegui fazer funcionar andar desconectando cabo, mas na transmissão de arquivos isso ainda não funciona efetivamente. (igual já ta feito na movimentação no sentido cliente->servidor tem que ser feito no sentido servidor->cliente com relação à reenvio de dados e timeout)
